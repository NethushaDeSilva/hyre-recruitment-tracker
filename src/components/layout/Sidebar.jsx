...
import { Briefcase, Users, Search, FileText, BadgeCheck, UserX, CalendarClock, CalendarRange, CalendarSearch, X } from "lucide-react";
...
function navFor(role) {
  ...
  if (can(role, "viewAvailabilityDirectory")) items.push({ to: "/availability/directory", label: "Interviewer Availability", icon: CalendarSearch });
